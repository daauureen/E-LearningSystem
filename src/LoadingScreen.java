...
public class LoadingScreen extends JFrame{
    ...
    public LoadingScreen(){
        ...
        upperPic = new JLabel();
        upperPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("src/icons/loadingIconImg.png")));
        ...
        backgroundPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("src/icons/background2.png")));
