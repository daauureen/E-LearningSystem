...
public class Main extends JFrame implements ActionListener{
    ...
    public Main(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("src/icons/MainTitle.png"));
        ...
        //Main Center Code
        ImageIcon loginImg1 = new ImageIcon(ClassLoader.getSystemResource("src/icons/login.png"));
        ...
        ImageIcon signUpImg1 = new ImageIcon(ClassLoader.getSystemResource("src/icons/signup.png"));
        ...
        ImageIcon mainPic1 = new ImageIcon(ClassLoader.getSystemResource("src/icons/ElearningMain.png"));
        ...
        // Footer Panel Code
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("src/icons/footer.png"));
